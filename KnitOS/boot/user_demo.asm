...
global user_wget_start
global user_wget_end
global user_wget_size
global user_curl_start
global user_curl_end
global user_curl_size
...
user_wget_start:
    incbin "user/wget.elf"
user_wget_end:
user_wget_size:
    dd user_wget_end - user_wget_start

user_curl_start:
    incbin "user/curl.elf"
user_curl_end:
user_curl_size:
    dd user_curl_end - user_curl_start