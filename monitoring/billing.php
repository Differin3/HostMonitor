...
?>
    ...
    <div class="tabs" style="margin-top: 24px;">
        <button class="tab-btn active" data-tab="billing" onclick="switchBillingTab('billing')">
            <i data-lucide="server"></i> Биллинг
        </button>
        <button class="tab-btn" data-tab="stats" onclick="switchBillingTab('stats')">
            <i data-lucide="bar-chart"></i> Статистика
        </button>
    </div>
    ...
    <div id="stats-tab" class="tab-content">
        <div class="grid-2" style="margin-top: 24px;">
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="monthly-chart" style="max-height: 260px;"></canvas>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <span>Расходы по провайдерам</span>
                    </div>
                </div>
                <div class="card-body">
                    <canvas id="provider-chart" style="max-height: 260px;"></canvas>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
            ...
            <form id="billing-form">
                ...
                <div class="form-field">
                    ...
                    <div class="input-with-icon">
                        ...
                        <select name="provider_name" id="billing-provider" class="provider-select" data-provider-select="name">
        ...
        <div class="modal-dialog">
            ...
            <form id="provider-form">
                ...
                <div class="form-field">
                    ...
                    <div class="form-hint-text">URL-адрес для входа — это URL-адрес страницы входа провайдера. Иконка будет сгенерирована автоматически из этого адреса.</div>
                    <div class="input-with-icon">
                ...
                <div class="form-field">
                    ...
                    <div class="form-hint-text">Опционально. Если не указано, будет автоматически сгенерирована из ссылки для входа.</div>
                    <div class="input-with-icon">
                        <i data-lucide="image" class="input-icon"></i>
                        <input type="url" name="favicon_url" id="provider-favicon" placeholder="Автоматически из ссылки для входа">
                    </div>
                </div>
                <div class="modal-actions">
    ...
    <div class="context-menu hidden" id="billing-context-menu">
        ...
        <div class="context-menu-actions">
            ...
            <button class="context-action-btn context-action-refresh" onclick="updateSelectedPaymentDates().catch(console.error)">
                <i data-lucide="calendar"></i> Обновить даты
            </button>
            <button class="context-action-btn context-action-delete" onclick="deleteSelectedBillingNodes().catch(console.error)">
