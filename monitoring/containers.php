...
?>
    ...
    <!-- Модальное окно для логов контейнера -->
    <div id="container-logs-modal" class="modal hidden">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="container-logs-title">
                    <i data-lucide="file-text" style="width: 24px; height: 24px; margin-right: 8px;"></i>
                    Логи контейнера
                </h2>
                <button class="modal-close" onclick="closeContainerLogsModal()">
                    <i data-lucide="x"></i>
                </button>
            </div>
            <div class="modal-body">
                <div class="logs-header">
                    <div class="logs-controls">
                        <button onclick="pauseContainerLogs()" id="pauseContainerLogsBtn">
                            <i data-lucide="pause"></i> Пауза
                        </button>
                        <button onclick="clearContainerLogs()">
                            <i data-lucide="trash-2"></i> Очистить
                        </button>
                        <button onclick="exportContainerLogs()">
                            <i data-lucide="download"></i> Экспорт
                        </button>
                        <label>
                            <input type="checkbox" id="autoScrollContainerLogs" checked> Автопрокрутка
                        </label>
                    </div>
                </div>
                <div id="container-logs-content" class="logs-content"></div>
            </div>
        </div>
    </div>
<?php
