...
function render_db_ha_panel(array $options = []): void
{
    ...
    <section class="db-ha-panel<?= $isCard ? ' card db-ha-panel-card' : '' ?>" id="db-ha-panel" data-db-ha-context="<?= htmlspecialchars($context) ?>">
        ...
        <div class="db-ha-panel-body">
            <div class="db-ha-locked-banner hidden" id="db-ha-locked-banner" role="alert">
                <i data-lucide="lock"></i>
                <span>Редактирование недоступно: нет соединения ни с основной, ни с резервной базой. Исправьте сервер MySQL или отредактируйте <code>data/db.local.php</code> по SSH.</span>
            </div>

            <?php if ($showIntro && !$isCard): ?>
            <p class="form-hint-text">Резерв необязателен. При падении основной панель переключится на запасную. Мониторинг сторонних СУБД — на странице «Базы данных».</p>
            <?php endif; ?>
            ...
            <div class="db-ha-body" id="db-ha-body">
                <h4 class="db-ha-section-title">Основная база</h4>
                <div class="ha-grid">
                ...
                <div class="db-ha-replica-block hidden" id="db-replica-fields">
                    <h4 class="db-ha-section-title">Резервная база</h4>
                    <div class="ha-grid">
                        <div class="form-field">
                    ...
                    <div class="db-ha-ca-block hidden" id="db-replica-ssl-ca-block">
                ...
                <?php if ($showSync): ?>
                <h4 class="db-ha-section-title">Синхронизация</h4>
